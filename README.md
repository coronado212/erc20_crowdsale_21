...
The step are divided into the following sections:
...
![](Images/comp_token.png)
KaseiCoin Crowdsale Contract - Compiled
![](Images/comp_crowdsale.png)
KaseiCoin Crowdsale Deployer - Compiled
![](Images/comp_crowdsaledep.png)
Crowdsale Deployed
![](Images/test1.gif)
Metamask Functionality
![](Images/dep_metamask.png)
Ganache Functionality
![](Images/dep_ganache.png)
Purchase Tokens & View Total Wei Raised
![](Images/test2.gif)
